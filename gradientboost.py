...
from fonctions_plot import plot_learning_curve,calculate_metrics_race,afficher_importance_features, correlation_train, correlation_test, plot_permutation_importance,confusion_matrix_for_sensitive_attribute,plot_results,plot_confusion,calculate_fairness_metrics,plot_complexity_curve
