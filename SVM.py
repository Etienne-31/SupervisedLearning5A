...
from fonctions_plot import plot_learning_curve,calculate_metrics_race, correlation_train_svm, correlation_test_svm, confusion_matrix_for_sensitive_attribute,plot_results,plot_confusion,calculate_fairness_metrics, plot_permutation_importance,plot_complexity_curve
